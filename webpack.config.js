...
CONFIG.alias = {
    umbrella_core: path.resolve(__dirname, './vendor/umbrella2/corebundle/Resources/assets/'),
    umbrella_admin: path.resolve(__dirname, './vendor/umbrella2/adminbundle/Resources/assets/')
};
...
if (devMode) {
    ...
    CONFIG.output.manifest = 'manifest.json';
}
